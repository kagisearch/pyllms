...
what does this program do, in one sentence?""",
    ...
    (
        "Use  g to substitute c, m to substitute p, a to substitute e, o to substitute h and n to substitute a how to spell cheap under this rule?",
        "goanm",
    ),
    (
...
Print the output""",
    ...
    (
        r"""Current flight information (the following flights are one-way only, and all the flights available are included below):
